...
import {DeployRaffle} from "../../script/Script.s.sol";
...
contract RaffleUnitTest is Test{
   ...
   function testRaffleIntializesInOpenState() public view {
     assert(raffle.getRaffleState() == raffle.s_raffleState());
   }
   ...
   function testCheckUpkeepReturnsFalseIfRaffleIsntOpen() public {
    // Ensure raffle is closed before calling checkUpkeep
  ...
  function testFullfillRandomWordsPicksWinnerResetAndSendMoney() public raffleEnteredAndTimePassed {
    // Arrange
